...
class DbClusterTopology extends Component {
  ...
  callApi = async () => {
    const response = await fetch(`/apis/dashboard/topology`);
        ...
        <div style={{}}>
          <div className="content-box">
            <div className="cb-header">
              <span onClick={this.onRefresh}>Cluster Topology</span>
...
export default DbClusterTopology;
