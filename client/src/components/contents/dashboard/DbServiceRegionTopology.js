...
class DbServiceRegionTopology extends Component {
  ...
  onRefresh = () => {
    ...
    series.nodes.template.tooltipText = "{name}: [bold]{data}[/]";
        ...
        <div style={{}}>
          <div className="content-box">
            <div className="cb-header">
              <span onClick={this.onRefresh}>Service-Region Topology</span>
