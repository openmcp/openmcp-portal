...
class CreateDeployment extends Component {
  ...
  handleSave = (e) => {
    ...
    const clusterName = this.state.selectedClusters[0];
    this.props.excuteScript(clusterName, context);
  ...
  render() {
    ...
    return (
      <div>
        ...
        >
          {t("deployments.pop-create.btn-create")}
        </div>
        <Dialog
        ...
        >
          <DialogTitle id="customized-dialog-title" onClose={this.handleClose}>
            {t("deployments.pop-create.title")}
          </DialogTitle>
...
class DpClusters extends Component {
  ...
  render() {
    ...
    const onSelectionChange = (selection) => {
      ...
      let selectedRows = this.state.rows[selection[0]]
...
export default withTranslation()(CreateDeployment);
