    ...
    if (this.props.new) {
      ...
      axios
        ...
        .then((res) => {
          ...
          utilLog.fn_insertPLogs(userId, "log-CF-EX04");
        })
        .catch((err) => {
          //close modal popup
      ...
      axios
        ...
        .then((res) => {
          ...
          utilLog.fn_insertPLogs(userId, "log-CF-EX05");
        })
        .catch((err) => {
          //close modal popup
          console.log("Error : ", err);
          ...
          <DialogContent dividers>
            <div className="md-contents-body" style={{ minWidth: "500px" }}>
              <section className="md-content">
                ...
                <div className="props">
                  <p>
                    {t("config.publicCloudAuth.gke.pop-common.credentialType")}
                  </p>
                  <TextField
                    id="outlined-multiline-static"
                    rows={1}
                ...
                <div className="props">
                  <p>
                    {t("config.publicCloudAuth.gke.pop-common.clientEmail")}
                  </p>
                  <TextField
                    id="outlined-multiline-static"
                    rows={1}
