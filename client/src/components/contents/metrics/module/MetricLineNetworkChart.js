...
class MetricLineNetworkChart extends Component {
  state = {
    ...
    return (
      ...
      <div>
        <h4>
            ...
            <span style={{fontSize:"13px", fontWeight:"normal",position:"absolute",right:"50px",top:"20px"}}>
                {this.props.cardinal ? 
...
export default MetricLineNetworkChart;
